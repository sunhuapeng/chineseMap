...
export const createShapes = (shapePath) => {
    ...
    let simplePaths = shapePath.subPaths.map(p => {
        ...
        return { curves: p.curves, points: points, isCW: THREE.ShapeUtils.isClockWise(points), identifier: identifier++, boundingBox: new THREE.Box2(new THREE.Vector2(minX, minY), new THREE.Vector2(maxX, maxY)) };
